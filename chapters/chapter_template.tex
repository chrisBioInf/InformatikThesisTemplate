...
\chapter{Chapter Title Here}% <- no space before %!
\label{chap:name} % choose a good name; use \autoref{chap:name} to reference.
...
Aliquam erat volutpat. Vivamus sodales tortor eget quam adipiscing in
vulputate ante ullamcorper. Sed eros ante, lacinia et sollicitudin et, aliquam
sit amet augue. In hac habitasse platea dictumst.
